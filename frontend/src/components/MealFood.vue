...
const props = defineProps(["food", "search"]);
const displayNutrients = ["Protein", "Carbohydrates", "Fats", "Calories"];
</script>

<template>
<div class="flex justify-between border-b-2 border-gray-700" :class="[!search ? 'bg-orange-200' : 'bg-gray-200']">
    <div class="flex">
        <!--
        ...
        -->
        <button v-if="!search" class="bg-gray-200 px-4 py-2 border-r-2 border-gray-700 hover:bg-gray-400 hover:text-gray-900">
    ...
    <div class="text-gray-500 flex text-base">
        ...
        <button v-if="!search" class="bg-red-300 text-red-500 px-4 py-2 flex items-center justify-center border-l-2 border-gray-700 py-4 px-4 hover:bg-red-400 hover:text-gray-700">
            <TrashIcon class="w-6"/>
        </button>
        <button v-else class="bg-gray-500 text-gray-200 px-4 py-2 flex items-center justify-center border-l-2 border-gray-700 py-4 px-4 hover:bg-gray-400 hover:text-gray-700">
            <PlusIcon class="w-6"/>
        </button>
    </div>
</div>
