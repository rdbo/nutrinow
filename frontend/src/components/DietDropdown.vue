            ...
            <MenuItems class="absolute left-0 z-10 w-full md:w-56 mt-2 origin-top-right rounded-md bg-white shadow-lg ring-2 ring-black ring-opacity-10 focus:outline-none">
                <div class="py-1">
                    ...
                    <MenuItem v-slot="{ active }">
                       <div @click="$emit('new-diet')" class="cursor-pointer flex items-center border-gray-300" :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-lg', diets.length ? 'border-t-2' : '']">
